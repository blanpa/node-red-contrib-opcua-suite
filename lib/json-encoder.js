...
function encodeNetworkMessage(networkMessage, _opts) {
  ...
  if (networkMessage.publisherId !== undefined) {
    ...
    const pidJson = (typeof pid === "bigint") ? JSON.stringify(pid.toString()) : JSON.stringify(pid);
  ...
  if (groupHeader && groupHeader.sequenceNumber !== undefined) {
    parts.push(`"SequenceNumber":${JSON.stringify(groupHeader.sequenceNumber)}`);
  }
  ...
  if (networkMessage.timestamp instanceof Date) {
    parts.push(`"Timestamp":${JSON.stringify(networkMessage.timestamp.toISOString())}`);
  }
...
function decodeNetworkMessage(jsonString, _opts) {
  ...
  if (obj.WriterGroupId !== undefined || obj.SequenceNumber !== undefined) {
    nm.groupHeader = {};
    if (obj.WriterGroupId !== undefined)  nm.groupHeader.writerGroupId  = obj.WriterGroupId;
    if (obj.SequenceNumber !== undefined) nm.groupHeader.sequenceNumber = obj.SequenceNumber;
  }
